...
const equipmentService = {
  ...
  create: async (data) => {
    ...
    const response = await axios.post('/api/equipment', payload);
  ...
  lend: async (id, borrowerInfo) => {
    const response = await axios.post(`/api/equipment/${id}/lend`, borrowerInfo);
    return response.data;
  },

  // Retourner un équipement
  return: async (id, returnInfo) => {
    const response = await axios.post(`/api/equipment/${id}/return`, returnInfo);
    return response.data;
  },
