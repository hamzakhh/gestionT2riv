@echo off
REM Script de déploiement pour Render - Association Management System
REM Auteur: hamzakhh
REM Email: khilihamza46@gmail.com
...
set BACKEND_REPO=association-backend
set FRONTEND_REPO=association-frontend
set GITHUB_USER=hamzakhh
